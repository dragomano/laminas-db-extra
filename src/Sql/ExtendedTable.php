...
class ExtendedTable extends CreateTable
{
    ...
    public function getSqlString(?PlatformInterface $adapterPlatform = null): string
    {
        ...
        if (in_array($platformName, ['sqlite', 'postgresql'], true)) {
            $originalConstraints = $this->constraints;
            $filteredConstraints = $this->separateIndexes = [];
    ...
    public function getIndexSqlStatements(?PlatformInterface $adapterPlatform = null): array
    {
        ...
        foreach ($this->separateIndexes as $index) {
            ...
            $indexStatements[] = /** @lang text */ "CREATE INDEX $indexName ON $tableName ($columnList)";
        }
